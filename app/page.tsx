        ...
        <main>
          <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
            <div className="text-center xl:text-left order-2 xl:order-none">
              ...
              <p className="max-w-[500px] mb-9 text-white/80">
                I am passionate about building dynamic web applications and have expertise in various programming languages.
              </p>
              <div className="flex flex-col xl:flex-row items-center gap-8">
                ...
                >
                  <a
                    href="/Ipseeka_Malla_Resume.pdf"  
                    download="Ipseeka_Malla_Resume.pdf"  
          ...
          <AnimatedSection id="projects">
            <div className="border-t border-gray-700 px-6 py-10">
              <div className="lg:w-400 md:w-200 sm:w-200  mx-auto">
                <ProjectSection />
              </div>
            </div>
          </AnimatedSection>
